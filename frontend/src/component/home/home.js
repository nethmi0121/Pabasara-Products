...
function Home() {
  ...
  const carouselImages = [
    { id: 1, src: image1, alt: 'Traditional sweet making process' },
    { id: 2, src: image2, alt: 'Our sweet shop interior' },
      ...
      <main className="home-container">
        ...
        <section className="about-section">
          <div className="about-content">
            ...
            <p>
              Since 1985, Pabasara Sweet House has been crafting authentic Sri Lankan sweets using 
